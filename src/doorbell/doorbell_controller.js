...
class DoorBellController {
    ...
    static getInstance() {
        if(!DoorBellControllerInstance) {
            DoorBellControllerInstance = new DoorBellController()
        }
        
        debug('DoorBellController constructed!')
        console.log('DoorBellController constructed!')
        return DoorBellControllerInstance;
    }
    ...
    ringDoorbell () {
        ...
        if (bell_trigger_start == 0) {
            ...
            setTimeout(this.awaitButtonPush,  bellPeriod);
